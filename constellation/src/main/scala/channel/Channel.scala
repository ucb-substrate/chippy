...
class Channel(val cParam: ChannelParams)(implicit val p: Parameters)
    extends Bundle {
...
class IngressChannel(val cParam: BaseChannelParams)(implicit val p: Parameters)
    extends Bundle {
...
class EgressChannel(val cParam: BaseChannelParams)(implicit val p: Parameters)
    extends Bundle {
  val payloadBits = cParam.payloadBits
