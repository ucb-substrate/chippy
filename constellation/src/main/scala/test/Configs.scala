...
class NoCTesterConfig(p: NoCTesterParams)
    extends Config((site, here, up) => { case NoCTesterKey =>
      p
    })

class TLNoCTesterConfig(p: TLNoCTesterParams)
    extends Config((site, here, up) => { case TLNoCTesterKey =>
      p
    })

class AXI4NoCTesterConfig(p: AXI4NoCTesterParams)
    extends Config((site, here, up) => { case AXI4NoCTesterKey =>
      p
    })

class NoCEvalConfig(p: NoCEvalParams)
    extends Config((site, here, up) => { case NoCEvalKey =>
      p
    })
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(3) { UserVirtualChannelParams(3) }),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(
              virtualChannelParams =
                Seq.fill(3) { UserVirtualChannelParams(3) },
          ...
          egresses = Seq(1, 1).map { i => UserEgressParams(1) },
          flows = Seq
            .tabulate(2, 2) { (s, d) => FlowParams(s, d, 0, fifo = true) }
            .flatten,
          routingRelation = UnidirectionalLineRouting()
        )
      )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          topology = UnidirectionalLine(3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(4) { UserVirtualChannelParams(5) }),
      ...
      NoCTesterParams(
        NoCParams(
          ...
          routerParams = (i) =>
            UserRouterParams(
              vcAllocator =
                (vP) => (p) => new PrioritizingSingleVCAllocator(vP)(p),
              coupleSAVA = true
            ),
          ingresses = Seq(0).map { i => UserIngressParams(i) },
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          egresses =
            Seq(0, 0, 1, 1, 2, 2, 3, 3).map { i => UserEgressParams(i) },
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(10, 10) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = UnidirectionalTorus1DDatelineRouting()
        ),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(20, 20) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = BidirectionalTorus1DRandomRouting()
        ),
        inputPacketStallProbability = 0.95
      )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(1) { UserVirtualChannelParams(5) }),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          egresses =
            (0 until 16).map { i => UserEgressParams((i % 8) + 8 * 3) },
          flows =
            Seq.tabulate(16, 16) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = ButterflyRouting()
        )
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          egresses =
            (0 until 18).map { i => UserEgressParams((i % 9) + 9 * 2) },
          flows =
            Seq.tabulate(18, 18) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = ButterflyRouting()
        )
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(1) { UserVirtualChannelParams(3) }),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(27, 27) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = BidirectionalTreeRouting()
        )
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows = Seq
            .tabulate(18, 18) { (s, d) => FlowParams(s, d, 0, fifo = true) }
            .flatten,
          routingRelation = Mesh2DDimensionOrderedRouting()
        )
      )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(25, 25) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = Mesh2DDimensionOrderedRouting()
        )
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          topology = Mesh2D(3, 3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(2) { UserVirtualChannelParams(2) }),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
          flows = Seq.tabulate(9, 9) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = Mesh2DEscapeRouting()
      ...
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(2) { UserVirtualChannelParams(2) }),
          routerParams =
            (i) => UserRouterParams(combineSAST = true, combineRCVA = true),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
          flows = Seq.tabulate(9, 9) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = Mesh2DEscapeRouting()
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          topology = Mesh2D(5, 5),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(1) { UserVirtualChannelParams(1) }),
          ingresses = (0 until 25).map { i => UserIngressParams(i) },
          egresses = (0 until 25).map { i => UserEgressParams(i) },
          flows =
            Seq.tabulate(25, 25) { (s, d) => FlowParams(s, d, 0) }.flatten,
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          topology = Mesh2D(3, 3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(4) { UserVirtualChannelParams(3) }),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
          flows = Seq
            .tabulate(9, 9) { (s, d) =>
            ...
            .flatten,
          routingRelation =
            BlockingVirtualSubnetworksRouting(Mesh2DEscapeRouting(), 4, 1),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(
              Seq.fill(4) { UserVirtualChannelParams(3) },
              useOutputQueues = false
            ),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
      ...
      NoCTesterParams(
        NoCParams(
          ...
          flows = Seq
            ...
            .flatten,
          routingRelation =
            NonblockingVirtualSubnetworksRouting(Mesh2DEscapeRouting(), 4, 1),
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(2) { UserVirtualChannelParams(1) }),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
          flows = Seq.tabulate(9, 9) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation =
            DimensionOrderedUnidirectionalTorus2DDatelineRouting()
        )
      )
    )
class TestConfig53
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          topology = UnidirectionalTorus2D(3, 3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(3) { UserVirtualChannelParams(4) }),
          ingresses = (0 until 9).map { i => UserIngressParams(i) },
          egresses = (0 until 9).map { i => UserEgressParams(i) },
          flows = Seq.tabulate(9, 9) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation =
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(
              Seq.fill(4) { UserVirtualChannelParams(4) },
              useOutputQueues = false
            ),
          ingresses = (0 until 25).map { i => UserIngressParams(i) },
          egresses = (0 until 25).map { i => UserEgressParams(i) },
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows = Seq.tabulate(9, 9) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation =
            DimensionOrderedBidirectionalTorus2DDatelineRouting()
        )
      )
    )
class TestConfig56
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(4) { UserVirtualChannelParams(4) }),
          ingresses = Seq(0, 1, 1).map { i => UserIngressParams(i) },
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows = Seq.tabulate(6, 6) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation =
            TerminalRouterRouting(UnidirectionalTorus1DDatelineRouting())
        ),
        inputPacketStallProbability = 0.9
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(12, 12) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation =
            TerminalRouterRouting(BidirectionalTorus1DShortestRouting())
        ),
        inputPacketStallProbability = 0.90
      )
    )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          egresses = (0 until 25).map { i => UserEgressParams(i) },
          flows = Seq
            .tabulate(25, 25) { (s, d) => FlowParams(s, d, 0, fifo = true) }
            .flatten,
          routingRelation =
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows = Seq
            .tabulate(16, 16) { (s, d) =>
              if (s % 3 == ((d + 2) % 3)) Some(FlowParams(s, d, s % 3))
              else None
            }
            .flatten
            .flatten,
          routingRelation = BlockingVirtualSubnetworksRouting(
            TerminalRouterRouting(Mesh2DEscapeRouting()),
            4
          ),
          vNetBlocking = (blocker, blockee) => blocker < blockee
        )
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(2) { UserVirtualChannelParams(5) }),
          ingresses = (0 until 16).map { i => UserIngressParams(i) },
          egresses = (0 until 16).map { i => UserEgressParams(i) },
          flows =
            Seq.tabulate(16, 16) { (s, d) => FlowParams(s, d, 0) }.flatten,
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(23, 23) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = HierarchicalRouting(
    ...
    extends NoCTesterConfig(
      NoCTesterParams(
        NoCParams(
          ...
          flows =
            Seq.tabulate(23, 23) { (s, d) => FlowParams(s, d, 0) }.flatten,
          routingRelation = TerminalRouterRouting(
            HierarchicalRouting(
              baseRouting = UnidirectionalTorus1DDatelineRouting(),
              childRouting = Seq(
                Mesh2DEscapeRouting(),
      ...
      NoCTesterParams(
        NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(4) { UserVirtualChannelParams(5) }),
          routerParams = (i) =>
            UserRouterParams(payloadBits = i match {
              case 0 | 4 => 36
              case 1 | 3 => 12
              case 2     => 24
            }),
          ingresses =
            Seq(0).map { i => UserIngressParams(i, payloadBits = 72) },
    ...
    extends TLNoCTesterConfig(
      TLNoCTesterParams(
        ...
        nocParams = NoCParams(
          topology = BidirectionalLine(2),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(5) { UserVirtualChannelParams(1) }),
          vNetBlocking = (blocker, blockee) => true,
    ...
    extends TLNoCTesterConfig(
      TLNoCTesterParams(
        ...
        nocParams = NoCParams(
          topology = Mesh2D(4, 3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(7) { UserVirtualChannelParams(3) }),
          vNetBlocking = (blocker, blockee) => true,
          routingRelation =
            NonblockingVirtualSubnetworksRouting(Mesh2DEscapeRouting(), 5, 1)
        )
      )
    )
class TLTestConfig02
    extends TLNoCTesterConfig(
      TLNoCTesterParams(
        inNodeMapping = Seq(4, 0, 2, 5, 6, 9, 11),
        outNodeMapping = Seq(7, 1, 3, 8, 10),
        nocParams = NoCParams(
          topology = Mesh2D(4, 3),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(5) { UserVirtualChannelParams(3) }),
          vNetBlocking = (blocker, blockee) => blocker < blockee,
          routingRelation =
            BlockingVirtualSubnetworksRouting(Mesh2DEscapeRouting(), 5)
        )
      )
    )
class TLTestConfig03
    extends TLNoCTesterConfig(
      TLNoCTesterParams(
        ...
        nocParams = NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(10) { UserVirtualChannelParams(3) }),
          vNetBlocking = (blocker, blockee) => blocker < blockee,
          routingRelation = NonblockingVirtualSubnetworksRouting(
    ...
    extends TLNoCTesterConfig(
      TLNoCTesterParams(
        ...
        nocParams = NoCParams(
          topology = TerminalRouter(Mesh2D(4, 3)),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(8) { UserVirtualChannelParams(7) }),
          routerParams = (i) =>
            UserRouterParams(
              vcAllocator =
                (vP) => (p) => new PrioritizingSingleVCAllocator(vP)(p)
...
class AXI4TestConfig00
    extends AXI4NoCTesterConfig(
      AXI4NoCTesterParams(
        inNodeMapping = Seq(0),
        outNodeMapping = Seq(1),
        nocParams = NoCParams(
    ...
    extends AXI4NoCTesterConfig(
      AXI4NoCTesterParams(
        ...
        nocParams = NoCParams(
          ...
          vNetBlocking = (blocker, blockee) => true,
          routingRelation = NonblockingVirtualSubnetworksRouting(
            TerminalRouterRouting(BidirectionalLineRouting()),
            5,
            1
          )
        )
    ...
    extends AXI4NoCTesterConfig(
      AXI4NoCTesterParams(
        ...
        nocParams = NoCParams(
          ...
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(10) { UserVirtualChannelParams(1) }),
          vNetBlocking = (blocker, blockee) => true,
          routingRelation = NonblockingVirtualSubnetworksRouting(
            TerminalRouterRouting(Mesh2DEscapeRouting()),
            5,
...
class EvalTestConfig00
    extends NoCEvalConfig(
      NoCEvalParams(
    ...
    extends NoCEvalConfig(
      NoCEvalParams(
        ...
        nocParams = NoCParams(
          topology = Mesh2D(4, 4),
          channelParamGen = (a, b) =>
            UserChannelParams(Seq.fill(1) { UserVirtualChannelParams(4) }),
          ingresses = (0 until 16).map { i => UserIngressParams(i) },
          egresses = (0 until 16).map { i => UserEgressParams(i) },
          flows =
            Seq.tabulate(16, 16) { (s, d) => FlowParams(s, d, 0) }.flatten,
