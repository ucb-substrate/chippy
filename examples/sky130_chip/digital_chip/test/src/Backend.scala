...
final class Backend(executablePath: String) extends svsim.Backend {
  type CompilationSettings = (Seq[String], Backend.CompilationSettings)
  ...
  def generateParameters(
    ...
    backendSpecificSettingsAll: CompilationSettings
    ...
    val additionalArgs = backendSpecificSettingsAll._1
    val backendSpecificSettings = backendSpecificSettingsAll._2
