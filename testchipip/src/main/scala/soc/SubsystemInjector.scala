...
abstract class SubsystemInjector(inject: (Parameters, BaseSubsystem) => Unit)
    extends Field[(Parameters, BaseSubsystem) => Unit](inject)
case object SubsystemInjectorKey
    extends Field[ListSet[SubsystemInjector]](ListSet.empty)
