...
case object AHBSlaveMonitorBuilder
    extends Field[AHBSlaveMonitorArgs => AHBSlaveMonitorBase]
...
object AHBImpSlave
  ...
  def edge(
      pd: AHBMasterPortParameters,
      pu: AHBSlavePortParameters,
      p: Parameters,
      sourceInfo: SourceInfo
  ) = AHBEdgeParameters(pd, pu, p, sourceInfo)
  def bundle(e: AHBEdgeParameters) = AHBSlaveBundle(e.bundle)
  def render(e: AHBEdgeParameters) = RenderedEdge(
...
case object AHBMasterMonitorBuilder
    extends Field[AHBMasterMonitorArgs => AHBMasterMonitorBase]
...
case class AHBMasterSourceNode(portParams: Seq[AHBMasterPortParameters])(
    implicit valName: ValName
) extends SourceNode(AHBImpMaster)(portParams)
case class AHBSlaveSourceNode(portParams: Seq[AHBMasterPortParameters])(implicit
    valName: ValName
) extends SourceNode(AHBImpSlave)(portParams)
case class AHBMasterSinkNode(portParams: Seq[AHBSlavePortParameters])(implicit
    valName: ValName
) extends SinkNode(AHBImpMaster)(portParams)
case class AHBSlaveSinkNode(portParams: Seq[AHBSlavePortParameters])(implicit
    valName: ValName
) extends SinkNode(AHBImpSlave)(portParams)
case class AHBMasterIdentityNode()(implicit valName: ValName)
    extends IdentityNode(AHBImpMaster)()
case class AHBSlaveIdentityNode()(implicit valName: ValName)
    extends IdentityNode(AHBImpSlave)()
