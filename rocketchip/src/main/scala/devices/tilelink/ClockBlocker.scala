...
/** This device extends a basic bus blocker by allowing it to gate the clocks of
  * the device whose tilelink port is being blocked. For now it is only possible
  * to block a single TL port and all the clocks simultaneously.
  */
