...
/** This black-boxes a Clock Divider by 2. The output clock is phase-aligned to
  * the input clock. If you use this in synthesis, make sure your sdc declares
  * that you want it to do the same.
  *
  * Because Chisel does not support blocking assignments, it is impossible to
  * create a deterministic divided clock.
  */
...
/** Divide the clock by power of 2 times.
  * @param pow2
  *   divides the clock 2 ^ pow2 times
  */
