...
class TutorialNoCConfig
    extends Config(
      ...
      new constellation.soc.WithGlobalNoC(
        ...
        new constellation.soc.WithPbusNoC(
          constellation.protocol.GlobalTLNoCParams(
        ...
        new constellation.soc.WithSbusNoC(
          constellation.protocol.GlobalTLNoCParams(
            constellation.protocol.DiplomaticNetworkNodeMapping(
              inNodeMapping =
                ListMap("Core 0" -> 0, "Core 1" -> 1, "serial-tl" -> 2),
              outNodeMapping = ListMap(
                "system[0]" -> 3,
                "system[1]" -> 4,
                "system[2]" -> 5,
